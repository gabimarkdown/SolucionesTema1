...
author: "Gabriel Val"
date:  "16/02/22"  #Pondría la fecha del día actual
params:
  lang: ES
...
```{r}
commonAnimals<-intersect(names1,names2)
...
```{r}
names<-setdiff(names1,names2) 
str(names) 
names_1<-setdiff(names2,names1) 
str(names_1)
...
```{r}
#la diferencia es que estan escritos de una manera distinta
...
#podemos asegurar al 95% que siguen una distribucion gaussiana
